            ...
            try:
                ...
                pipeline_context = {
                    ...
                    **(fetch_step.get("outputs") or {}),
                    ...
                    "failure_status": current_status if current_status == "FAIL-TEST" else "",
                    "migration_sql": (fetch_step.get("outputs") or {}).get("saved_migration_sql", "") if current_status == "FAIL-TEST" else "",
                }
