        ...
        logging.getLogger("smartmigrate.workflow").info(
            ...
            extra={
                "workflow_log": {
                    "map_id": 0,
                    "mig_kind": "WORKFLOW",
                    "log_type": "11_FINAL_DASH",
                    "log_level": "INFO",
                    "step_name": "BUILD_RESULT",
                    "status": "START",
                    "message": "before build_result",
                    "retry_count": 0,
                }
            },
        )
            ...
            logging.getLogger("smartmigrate.workflow").error(
                ...
                extra={
                    "workflow_log": {
                        ...
                        "step_name": "BUILD_RESULT",
                        "status": "ERROR",
                        "message": f"error build_result: {exc}",
                        "retry_count": 0,
                    }
                },
            )
