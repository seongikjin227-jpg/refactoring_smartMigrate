...
- MANAGEMENT: Dashboard 조회, 상태/현황/건수/실패 현황/잔여 작업 조회, 특정 작업의 결과/상태/로그/실패 원인 조회, SQL Conversion/Tuning/Formatting 최근 진행 상황 해석, priority/status/USE_YN 변경, Correct SQL 입력.
