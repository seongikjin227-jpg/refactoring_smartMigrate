...
class NewType17ASqlFormattingJobsToLoopTable(Component):
    ...
    def build_jobs_table(self) -> DataFrame:
        self._insert_log(0, "WORKFLOW", "17A_SQL_JOBS", "INFO", "BUILD_JOBS_TABLE", "START", "before build_jobs_table", 0, "")
        try:
            ...
            self._insert_log(0, "WORKFLOW", "17A_SQL_JOBS", "INFO", "BUILD_JOBS_TABLE", "END", "after build_jobs_table", 0, "")
            return __log_result
        except Exception as exc:
            self._insert_log(0, "WORKFLOW", "17A_SQL_JOBS", "ERROR", "BUILD_JOBS_TABLE", "ERROR", f"error build_jobs_table: {exc}", 0, "")
            raise
