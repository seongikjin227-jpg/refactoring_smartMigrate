...
class NewType12BSqlConversionLoop(Component):
    ...
    async def item_output(self) -> Data:
        ...
        try:
            ...
            logging.getLogger("smartmigrate.workflow").info("after item_output", extra={"workflow_log": [0, "WORKFLOW", "12B_SQL_LOOP", "INFO", "ITEM_OUTPUT", "END", 0]})
            return __log_result
        except Exception as exc:
    ...
    async def done_output(self) -> Data:
        ...
        try:
            ...
            logging.getLogger("smartmigrate.workflow").info("after done_output", extra={"workflow_log": [0, "WORKFLOW", "12B_SQL_LOOP", "INFO", "DONE_OUTPUT", "END", 0]})
            return __log_result
        except Exception as exc:
