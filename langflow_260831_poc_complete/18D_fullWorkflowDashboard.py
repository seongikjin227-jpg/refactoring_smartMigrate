...
class NewType18DFullWorkflowDashboard(Component):
    ...
    def build_message(self) -> Message:
        ...
        try:
            ...
            logging.getLogger("smartmigrate.workflow").info("after build_message", extra={"workflow_log": [0, "WORKFLOW", "18D_FULL_DASH", "INFO", "BUILD_MESSAGE", "END", 0]})
            return __log_result
    ...
    def build_loop_result(self) -> Data:
        ...
        try:
            ...
            logging.getLogger("smartmigrate.workflow").info("after build_loop_result", extra={"workflow_log": [0, "WORKFLOW", "18D_FULL_DASH", "INFO", "BUILD_LOOP_RESULT", "END", 0]})
            return __log_result
        except Exception as exc:
